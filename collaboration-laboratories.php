		...
		<div class="page-header">
		    <div class="container">
		        <div class="breadc-box no-line">
		            <div class="row">
		                <div class="col-md-12">
		                    <h3 class="page-title">Collaboration with NABL Accredited Laboratories</h3>
		                    <ul id="breadcrumbs" class="breadcrumbs none-style">
		                        <li><a href="index.php">Home</a></li>
		                        <li class="active">Collaboration with NABL Accredited Laboratories</li>
		                    </ul>
		                </div>
		            </div>
		        </div>
			...
			<div class="container">
				<div class="row flex-row">
					<div class="col-md-12 col-sm-12 align-self-center">
						<h3 class="text-primary" style="padding-top:30px;">Collaboration with NABL Accredited Laboratories</h3>

						<p align="justify">We extensively make use of the services offered by National Level Testing Laboratories to verify our quality and provide you complete satisfaction.</p>
