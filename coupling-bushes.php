		...
		<div class="page-header">
		    ...
		    <div class="container">
		        <div class="breadc-box no-line">
		            <div class="row">
		                <div class="col-md-12">
		                		<h3 class="page-title">Coupling Bushes</h3>
		                		<ul id="breadcrumbs" class="breadcrumbs none-style">
		                		    <li><a href="index.php">Home</a></li>
		                		    <li class="active">Coupling Bushes</li>
		                		</ul>
			...
			<div class="container">
				<div class="row flex-row">
					<div class="col-md-12 col-sm-12 align-self-center">
						<h3 class="text-primary" style="padding-top:30px;">Rubber Coupling Bushes</h3>
						<p align="justify">Universal Pin Bush Couplings ensures high torque transmissions
						 at high speeds, in a way, coupling have remarkable shock absorption capacity due 
						 to construction being cushioned drive type transmitting the torque through rubber 
						 bushes.</p>
						...
						<div class="project-filter" data-column="">
							...
							<div id="projects" class="project-grid gallery row ">
								...
								<div class="project-item clients events col-lg-4 col-sm-6">
						            <div class="inner">
									<a href="images/coupling-bushes/2.jpg" class="image-link imghvr-shutter-out-vert" title="gallery zoom image">
						                    <img src="images/coupling-bushes/2.jpg" alt=""> 
						                </a>
								...
								<div class="project-item clients gproject col-lg-4 col-sm-6">
						            <div class="inner">
									<a href="images/coupling-bushes/3.jpg" class="image-link imghvr-shutter-out-vert" title="gallery zoom image">
						                    <img src="images/coupling-bushes/3.jpg" alt=""> 
										</a>
						            </div>
						        </div>
								<div class="project-item events clients gproject col-lg-4 col-sm-6">
						            <div class="inner">
						            <a href="images/coupling-bushes/5.jpg" class="image-link imghvr-shutter-out-vert" title="gallery zoom image">
						                    <img src="images/coupling-bushes/5.jpg" alt=""> 
										</a>
						            </div>
						        </div>
							</div>
