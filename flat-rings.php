		...
		<div class="page-header">
		    ...
		    <div class="container">
		        <div class="breadc-box no-line">
		            <div class="row">
		                <div class="col-md-12">
		                		<h3 class="page-title">Flat Ring </h3>
		                		<ul id="breadcrumbs" class="breadcrumbs none-style">
		                		    <li><a href="index.php">Home</a></li>
		                		    <li class="active">Flat Ring</li>
		                		</ul>
			...
			<div class="container">
				<div class="row flex-row">
					<div class="col-md-12 col-sm-12 align-self-center">
						<h3 class="text-primary"  style="padding-top:30px;">Rubber Flat Rings</h3>
						<p align="justify">Flat gaskets provide the static sealing of two flat sealing surfaces. Since flat gaskets are especially used in the chemical industry, but as well in the food and beverage and pharmaceutical industry. ... For secure sealing, a flat gasket is used; contact pressure is applied to it.</p>
						...
						<div class="project-filter" data-column="">
							...
							<div id="projects" class="project-grid gallery row ">
								...
								<div class="project-item clients events col-lg-4 col-sm-6">
						            <div class="inner">
									<a href="images/Flat-Ring.jpg" class="image-link imghvr-shutter-out-vert" title="gallery zoom image">
						                    <img src="images/Flat-Ring.jpg" alt=""> 
						                </a>
								...
								<div class="project-item clients gproject col-lg-4 col-sm-6">
						            <div class="inner">
									<a href="images/rubber-flat-rings-500x500.jpg" class="image-link imghvr-shutter-out-vert" title="gallery zoom image">
						                    <img src="images/rubber-flat-rings-500x500.jpg" alt=""> 
										</a>
						            </div>
						        </div>
								<div class="project-item events clients gproject col-lg-4 col-sm-6">
						            <div class="inner">
						            <a href="images/rubber-flat-rings-500x500.jpeg" class="image-link imghvr-shutter-out-vert" title="gallery zoom image">
						                    <img src="images/rubber-flat-rings-500x500.jpeg" alt=""> 
										</a>
						            </div>
						        </div>
							</div>
