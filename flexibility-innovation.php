		...
		<div class="page-header">
		    <div class="container">
		        <div class="breadc-box no-line">
		            <div class="row">
		                <div class="col-md-12">
		                    <h3 class="page-title">Flexibility and Openness to Innovations</h3>
		                    <ul id="breadcrumbs" class="breadcrumbs none-style">
		                        <li><a href="index.php">Home</a></li>
		                        <li class="active">Flexibility and Openness to Innovations</li>
		                    </ul>
		                </div>
		            </div>
		        </div>
			...
			<div class="container">
				<div class="row flex-row">
					<div class="col-md-12 col-sm-12 align-self-center">
						<h3 class="text-primary" style="padding-top:30px;">Flexibility and Openness to Innovations</h3>

						<p align="justify">Idea generation and Innovations that promise even the slightest of improvement are welcomed at all levels. Despite its rapid growth, the company maintains the flexibility of a small company, always alert and open to new ideas.</p>
