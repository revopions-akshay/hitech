			...
			<div class="container">
				<div class="row flex-row">
					<div class="col-md-12 col-sm-12 align-self-center">
						<h3 class="text-primary" style="padding-top:30px;">Reparing of All Types of Butterfly Valves</h3>
						<p align="justify">The minor repair process of butterfly valves in various pipelines, 
						include cleaning nozzle and oil cup, replace the O-rings, clear thread and stem,
						 remove debris inside the valve, fastening the screw, allocate hand wheel. All of
						  these can be used as the timing of the maintenance.</p>
						...
						<div class="project-filter" data-column="">
							...
							<div id="projects" class="project-grid gallery row ">
								...
								<div class="project-item clients events col-lg-4 col-sm-6">
						            <div class="inner">
									<a href="images/valves/butterfly-head.jpg" class="image-link imghvr-shutter-out-vert" title="gallery zoom image">
						                    <img src="images/valves/butterfly-head.jpg" alt=""> 
										</a>
						            </div>
						        </div>
								<div class="project-item clients gproject col-lg-4 col-sm-6">
						            <div class="inner">
									<a href="images/valves/butterfly-valves-maintenance.jpg" class="image-link imghvr-shutter-out-vert" title="gallery zoom image">
						                    <img src="images/valves/butterfly-valves-maintenance.jpg" alt=""> 
										</a>
						            </div>
						        </div>
								<div class="project-item events clients gproject col-lg-4 col-sm-6">
						            <div class="inner">
						            	<a href="images/valves/ultraflo-family.png" class="image-link imghvr-shutter-out-vert" title="gallery zoom image">
						                    <img src="images/valves/ultraflo-family.png" alt=""> 
						                </a>
						            </div>
						        </div>
							</div>
