		...
		<div class="page-header">
		    ...
		    <div class="container">
		        <div class="breadc-box no-line">
		            <div class="row">
		                <div class="col-md-12">
		                		<h3 class="page-title">Rubber Bucket for Hydraulic</h3>
		                		<ul id="breadcrumbs" class="breadcrumbs none-style">
		                		    <li><a href="index.php">Home</a></li>
		                		    <li class="active">Rubber Bucket for Hydraulic</li>
		                		</ul>
			...
			<div class="container">
				<div class="row flex-row">
					<div class="col-md-12 col-sm-12 align-self-center">
						<h3 class="text-primary" style="padding-top:30px;">Rubber Bucket for hydraulic</h3>
						<p align="justify">Hydraulic rubber buckets are bucket shaped rubber seals mostly
						 used in sugar industry.</p>
						...
						<div class="project-filter" data-column="">
							...
							<div id="projects" class="project-grid gallery row ">
								...
								<div class="project-item clients events col-lg-4 col-sm-6">
						            <div class="inner">
									<a href="images/rubberbucket/1.png" class="image-link imghvr-shutter-out-vert" title="gallery zoom image">
						                    <img src="images/rubberbucket/1.png" alt=""> 
						                </a>
								...
								<div class="project-item clients gproject col-lg-4 col-sm-6">
						            <div class="inner">
									<a href="images/rubberbucket/2.jpg" class="image-link imghvr-shutter-out-vert" title="gallery zoom image">
						                    <img src="images/rubberbucket/2.jpg" alt=""> 
										</a>
						            </div>
						        </div>
								<div class="project-item events clients gproject col-lg-4 col-sm-6">
						            <div class="inner">
						            <a href="images/rubberbucket/3.jpg" class="image-link imghvr-shutter-out-vert" title="gallery zoom image">
						                    <img src="images/rubberbucket/3.jpg" alt=""> 
										</a>
						            </div>
						        </div>
							</div>
