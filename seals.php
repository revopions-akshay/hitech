		...
		<div class="page-header">
		    ...
		    <div class="container">
		        <div class="breadc-box no-line">
		            <div class="row">
		                <div class="col-md-12">
		                		<h3 class="page-title">Seals</h3>
		                		<ul id="breadcrumbs" class="breadcrumbs none-style">
		                		    <li><a href="index.php">Home</a></li>
		                		    <li class="active">Seals</li>
		                		</ul>
			...
			<div class="container">
				<div class="row flex-row">
					<div class="col-md-12 col-sm-12 align-self-center">
						<h3 class="text-primary"  style="padding-top:30px;">Rubber Seals</h3>
						<p align="justify">askets seal a connection between two components or flanges that have flat surfaces, while seals are used between engine parts, pumps, and shafts that rotate. Gaskets are used wherever a union or flange is required to prevent leaking.</p>
						...
						<div class="project-filter" data-column="">
							...
							<div id="projects" class="project-grid gallery row ">
								...
								<div class="project-item clients events col-lg-4 col-sm-6">
						            <div class="inner">
									<a href="images/seals/1.jpg" class="image-link imghvr-shutter-out-vert" title="gallery zoom image">
						                    <img src="images/seals/1.jpg" alt=""> 
						                </a>
								...
								<div class="project-item clients gproject col-lg-4 col-sm-6">
						            <div class="inner">
									<a href="images/seals/2.png" class="image-link imghvr-shutter-out-vert" title="gallery zoom image">
						                    <img src="images/seals/2.png" alt=""> 
										</a>
						            </div>
						        </div>
								<div class="project-item events clients gproject col-lg-4 col-sm-6">
						            <div class="inner">
						            <a href="images/seals/3.jpg" class="image-link imghvr-shutter-out-vert" title="gallery zoom image">
						                    <img src="images/seals/3.jpg" alt=""> 
										</a>
						            </div>
						        </div>
							</div>
