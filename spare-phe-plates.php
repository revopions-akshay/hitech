			...
			<div class="container">
				<div class="row flex-row">
					<div class="col-md-12 col-sm-12 align-self-center">
						<h3 class="text-primary" style="padding-top:30px;">Spares PHE Plates</h3>
						...
						<div class="project-filter" data-column="">
							...
							<div id="projects" class="project-grid gallery row ">
								...
								<div class="project-item clients events col-lg-4 col-sm-6">
						            <div class="inner">
						            	<a href="images/phegasket/liner_article_image2.gif" class="image-link imghvr-shutter-out-vert" title="gallery zoom image">
						                    <img src="images/phegasket/liner_article_image2.gif" alt=""> 
						                </a>
						            </div>
						        </div>
								<div class="project-item clients gproject col-lg-4 col-sm-6">
						            <div class="inner">
						            	<a href="images/phegasket/phe explained 2.jpg" class="image-link imghvr-shutter-out-vert" title="gallery zoom image">
						                    <img src="images/phegasket/phe explained 2.jpg" alt=""> 
						                </a>
						            </div>
						        </div>
