		...
		<div class="page-header">
		    <div class="container">
		        <div class="breadc-box no-line">
		            <div class="row">
		                <div class="col-md-12">
		                    <h3 class="page-title">State-of-the-art Manufacturing Facilities</h3>
		                    <ul id="breadcrumbs" class="breadcrumbs none-style">
		                        <li><a href="index.php">Home</a></li>
		                        <li class="active">State-of-the-art Manufacturing Facilities</li>
		                    </ul>
		                </div>
		            </div>
		        </div>
			...
			<div class="container">
				<div class="row flex-row">
					<div class="col-md-12 col-sm-12 align-self-center">
						<h3 class="text-primary">State-of-the-art Manufacturing Facilities</h3>

						<p align="justify">We ensure to continuously update our manufacturing facilities in order to produce and hence supply high quality products at low manufacturing costs..</p>
						<h4>List of Hi-Tech Rubber Technical Facilities</h4>
						<ul>
